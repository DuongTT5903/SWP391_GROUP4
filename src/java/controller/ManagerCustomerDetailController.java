...
/**
 * Servlet để quản lý chi tiết khách hàng
 */
public class ManagerCustomerDetailController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean gender = "true".equals(genderStr); // Tránh NullPointerException
    ...
    private String validateInput(int userID, String name, String email, String phone, String username, String password, UserDBContext db) {
        ...
        if (password != null && !password.isEmpty() && password.length() < 6) return "Mật khẩu phải có ít nhất 6 ký tự.";
