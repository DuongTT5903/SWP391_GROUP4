            ...
            <table id="myTable">
                ...
                <c:forEach var="user" items="${users}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/manager/customerDetail?id=${user.userID}" class="btn btn-primary">Chi tiết</a>
                            <form action="customerList" method="post" onsubmit="return confirmStatusChange(${user.status.status})">
